...
namespace AirportLockerRental.UI.Actions
{
    public static class ConsoleIO
    {
        ...
        public static ILockerRepository GetStorageType()
        {
            ...
            do
            {
                ...
                if (int.TryParse(Console.ReadLine(), out choice))
                {
                    ...
                    {
                        return new JsonLockerRepository(GetCapacity());
                    }
                }
        ...
        public static void DisplayAllLockerContents(LockerContents? dto)
        {
            ...
            if(dto != null)
            {
                ...
                Console.WriteLine($"Renter Name: {dto.UserName}");
                Console.WriteLine($"Contents: Please see individual locker to see data");
                Console.WriteLine("=====================================");
            }
        }
        public static void DisplayLockerContents(LockerContents? dto, string description)
        {
        ...
        public static LockerContents GetLockerContentsFromUser()
        {
            ...
            contents.UserName = GetRequiredString("Enter your name: ");
        ...
        {
            Console.WriteLine("Please enter a password for this locker: ");
            return Console.ReadLine();
        }
        public static string GetUserName()
        {
            Console.WriteLine("Please enter the username for this locker: ");
            return Console.ReadLine();
        }
    }
}
